...
**Ruta del proyecto:** `~/Desktop/HTECH/CLAUDE CODE/projects/meta-ads-diagnostic/`
...
Busca subcarpetas en: `~/Desktop/HTECH/CLAUDE CODE/projects/meta-ads-diagnostic/analyser/{casino}/`
...
```bash
cd "~/Desktop/HTECH/CLAUDE CODE/projects/meta-ads-diagnostic" && python3 generator.py parse {casino} {period}
```
...
```bash
cd "~/Desktop/HTECH/CLAUDE CODE/projects/meta-ads-diagnostic" && python3 generator.py generate {casino} {period} --analysis /tmp/meta-ads-analysis.json
```
...
## Paso 6 — Abrir y confirmar

```bash
open "~/Desktop/HTECH/CLAUDE CODE/projects/meta-ads-diagnostic/output/{casino}/diagnostico-{casino}_{period}.html"
```
